...
function setup({ cardsFlipped }) {
  ...
  const enzymeWrapper = (<BoardCards  {...props} />);
...
describe("Board Container", () => {
  test("The five images have something rendered", () => {
    ...
    [0, 1, 2, 3, 4].forEach((imageIndex) => {
        ...
        expect(enzymeWrapper.find("img#Board" + imageIndex + "Card")).toBeTruthy();
        expect(enzymeWrapper.find("img#Board" + imageIndex + "Card").length).toEqual(1);
    })
  });
