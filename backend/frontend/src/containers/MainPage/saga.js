...
let baseURL = "https://www.poker-range-appalyzer.com";

/**
 * Get All Hand Ranges request/response handler
 */
export function* saveScenario({
  data: { deadcards, rangeRepoIP, rangeRepoOOP, user, token }
}) {
  const requestUrl = `https://www.poker-range-appalyzer.com/api/private`;
